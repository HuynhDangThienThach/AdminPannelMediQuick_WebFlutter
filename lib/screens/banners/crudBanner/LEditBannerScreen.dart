...
class LEditBannerScreen extends StatefulWidget {
  const LEditBannerScreen({super.key, required this.bannerId});

  final String bannerId;

  @override
  State<LEditBannerScreen> createState() => _LEditBannerScreenState();
}

class _LEditBannerScreenState extends State<LEditBannerScreen> {
  ...
  Future<void> _loadBannerData() async {
    await controller.getBannerById(widget.bannerId);
  ...
  Future<void> _pickImage() async {
    ...
    if (result != null && result.files.single.bytes != null) {
      ...
      await controller.uploadImageToFirebase(
          _imageData!, result.files.single.name);
    }
  }
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 16.0),
                          ElevatedButton(
                              onPressed: _pickImage, child: Text('Chọn ảnh')),
                          SizedBox(height: 16.0),
                          Row(
                      ...
                      TextFormField(
                        ...
                        validator: (value) =>
                            TValidator.validateBannerRedirect(value),
                        style: TextStyle(color: Colors.white),
                      ),
                    ],
                  ),
